  ...
  return (
    <div className="mx-auto max-w-6xl rounded-2xl bg-white p-8 shadow-md">
      ...
      <p className="mt-2 text-sm text-slate-500">
        Manage the PeerPrep question bank.
      </p>
        ...
        <form onSubmit={handleCreateQuestion} className="mt-6 space-y-4">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              <p className="block text-sm font-medium text-slate-700">Topics</p>
              <button
                type="button"
                onClick={() => {
            ...
            {showAddTopicInput && (
              <div className="mb-4 rounded-lg border border-slate-200 p-3">
                ...
                {topicMessage && (
                  <p className="mt-2 text-sm text-green-600">{topicMessage}</p>
                )}
                {topicError && (
                        ...
                        >
                          ...
                          {openMenuQuestionId === question.id && (
                            <div className="absolute right-0 z-10 mt-2 w-48 rounded-lg border border-slate-200 bg-white shadow-lg">
                              {question.availability_status === "available" && (
                                <>
                                  <button
                                    type="button"
                              ...
                              {question.availability_status === "archived" && (
                                <>
                                  <button
                                    type="button"
                                    onClick={() =>
                    ...
                    {editingQuestionId === question.id && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {topics.map((topic) => {
                              const selected = editTopics.includes(topic.name);
                              return (
                                <button
                                  key={topic.name}
                                  type="button"
      ...
      <div className="mt-6 rounded-xl border border-slate-200 p-5">
        ...
        <p className="mt-2 text-sm text-slate-500">
          This section will be added after backend support is ready.
        </p>
      </div>
    </div>
  );
